...
<% 
	...
	System.out.println(ad.getID() + " admin homepage");
%>
                ...
                <div id="main-content">
					...
					<% 
			    		...
			    		try {
			    			...
			    			ps = con.prepareStatement("select * from teaches, course where course.course_id = teaches.course_id and teacher_id = ? ");
			    			ps.setString(1, uid);
			    			rs = ps.executeQuery();
			    			while(rs.next())	{
				    			...
				    			<% 
				    				...
				    				courseNo+=1;
				    			%>
				    			<form action="TeacherViewStudents" method="post">
				    				<input type="hidden" name = courseID value= <%= rs.getString("course_id") %> >
				    				<input type="hidden" name = teacherName value= <%= ad.getName() %> >
